...
from provider.dialogs_control import ParsedControl
from provider.dialogs_nlu import ParsedCommand
from provider.skill_manifest_provider import (
...
class TestBundledResourceLookup:
    ...
    def test_no_hardcoded_package_string_literal(self) -> None:
        ...
        from provider import skill_manifest_provider as smp  # noqa: PLC0415
