#!/bin/sh
# Init script for Yandex Alice provider Docker dev environment.
# Auto-generated by ma-provider-tools — do not edit manually.
set -e

echo "==> Setting up Yandex Alice provider..."
...
rm -rf "${PROVIDERS_DIR}/yandex_alice"
ln -s /tmp/provider "${PROVIDERS_DIR}/yandex_alice"
echo "==> Provider linked: ${PROVIDERS_DIR}/yandex_alice"
