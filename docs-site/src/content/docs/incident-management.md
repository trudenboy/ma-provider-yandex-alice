...
# Yandex Alice — Управление инцидентами

## Куда заводить инциденты

> **Заводи задачи здесь:** [github.com/trudenboy/ma-provider-yandex-alice/issues](https://github.com/trudenboy/ma-provider-yandex-alice/issues)
...
- **Поле Provider**: устанавливается автоматически для Yandex Alice
