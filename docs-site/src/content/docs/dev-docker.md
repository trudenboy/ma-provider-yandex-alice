...
# Yandex Alice — локальная разработка через Docker

Запусти полноценный Music Assistant с провайдером Yandex Alice одной командой —
...
## Подключение провайдера Yandex Alice

После входа:

1. Перейди в **Settings** → **Providers**
2. Найди **Yandex Alice** в списке — он уже доступен, код загружен автоматически
